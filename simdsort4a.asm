...
pass1_add4 OWORD 000000003000000030000000100000001h
pass2_add4 OWORD 000000003000000020000000300000002h
pass3_add4 OWORD 000000003000000020000000200000000h
...
simdsort4a PROC
	...
	vpaddd      xmm1, xmm1, xmmword ptr [pass1_add4]
	...
	vpcmpgtd    xmm1, xmm1, xmm0
	vpaddd      xmm1, xmm1, xmmword ptr [pass3_add4]
	vpermilps   xmm0, xmm0, xmm1
